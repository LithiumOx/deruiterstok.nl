	...
	<div class="text-center hero-content">
		<div class="max-w-md">
			<lottie-player
				...
				autoplay
			/>
			<h1 class="mb-10 text-4xl font-bold text-base-content subpixel-antialiased">
				Seizoen 2021-2022
			</h1>
			<p class="mb-5 text-base-content align-middle subpixel-antialiased">
			...
			<a
				href="mailto:ruiterstok@outlook.com?subject=Ik%20wil%20lid%20worden!&body=(Wanneer%20wij%20deze%20mail%20ontvangen%20krijg%20je%20een%20tikkie%20terug%20gemaild)%0D%0A%0D%0ANaam%3A%0D%0AGeboortedatum%3A%0D%0AMobiel%20nummer%3A%0D%0A%0D%0A(Geen%2018%2B%3F%20Graag%20het%20nummer%20van%20je%20ouders)"
				class="btn btn-primary subpixel-antialiased">Wordt lid!</a
			>
		</div>
	</div>
</div>
>>>>>>> 712d149b653c2e787a00e12c95639372d66933b5
